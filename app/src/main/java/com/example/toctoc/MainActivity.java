...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    String serverIp="192.168.2.40";   // 메인 호스트 서버의 주소
    int serverPort=7000;              // 서버 실행시 포트넘버 주의! 필요시 수정하면서 쓸것
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ap = new MyAdapter(MainActivity.this, R.layout.chat_item, list); // 1. 컨텍스트 메인액티비티.this로 수정
...
class MyAdapter extends ArrayAdapter<ChatMessage> { // 1_1. 어댑터 먼저 Import Class해주기
    ArrayList<ChatMessage> list;
    int resId;
    Context context;
